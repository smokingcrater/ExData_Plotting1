...
generate_plot1 <- function(file_raw_data, date_start, date_end, file_output)
{
	# Read the data.
	...
	hist(df_epc[,"global_active_power"], main="Global Active Power", xlab="Global Active Power (kilowatts)", col="red")
	dev.off()
}

generate_plot1("household_power_consumption.txt", "1/2/2007", "3/2/2007", "plot1.png")