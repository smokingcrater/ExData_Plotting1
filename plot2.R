...
generate_plot2 <- function(file_raw_data, date_start, date_end, file_output)
{
	# Read the data.
	...
	plot(df_epc[,"date_time"], df_epc[,"global_active_power"], type="l", xlab="", ylab="Global Active Power (kilowatts)")
	dev.off()
}

generate_plot2("household_power_consumption.txt", "1/2/2007", "3/2/2007", "plot2.png")
